...
class OrderUpdateTest {
    ...
    void getValidUpdatesMiddleSum_example() {
        ...
        OrderUpdate validator = new OrderUpdate(rules.getRules(), rules.getPrintPages());
        assertEquals(123, validator.getValidUpdatesMiddleSum());
    }
    ...
    void getValidUpdatesMiddleSum_input_puzzle(){
        ...
        OrderUpdate validator = new OrderUpdate(rules.getRules(), rules.getPrintPages());
        assertEquals(6456, validator.getValidUpdatesMiddleSum());
    }
}