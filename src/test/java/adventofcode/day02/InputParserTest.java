...
public class InputParserTest {
    ...
    public void testShortInput() {
        ...
        Map<Integer, List<Map<ColorEnum, Integer>>> expectedGameInformation = getShortExpectedGameInformation();
    ...
    private  Map<Integer, List<Map<ColorEnum, Integer>>> getShortExpectedGameInformation() {
        return Map.of(
                1, List.of(
