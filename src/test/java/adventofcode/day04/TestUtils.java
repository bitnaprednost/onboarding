...
public class TestUtils {
    ...
    public static List<Scratchcard> getListOfScratchcardsForInputOne() {
        return List.of(
                new Scratchcard(
    ...
    public static String getInputAllWinningNumbers() {
        return  "Card 1: 41 48 83 86 17 | 83 86 41 31 17  9 48 53\n" +
                "Card 2: 13 32 20 16 61 | 61 13 20 82 16 32 24 19\n";
    }

    public static String getInputNoWinningNumber() {
        return  "Card 1: 41 48 83 86 17 | 1 2 3 4 5 6 7 8\n" +
