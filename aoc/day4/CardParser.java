...
import common.ConvertToIntArray;
...
public class CardParser {
    ...
    public CardParser(String cardLine) {
        ...
        this.winningNumbers = ConvertToIntArray.convertToIntArray(parts[0].trim().split("\\s+"));
        this.playerNumbers = ConvertToIntArray.convertToIntArray(parts[1].trim().split("\\s+"));
